...
import {ActionCodeSettings, AuthError, User, UserCredential} from 'firebase/auth';
...
const initialState: AppAuthProviderState = {
  ...
  sendPasswordResetEmail: function (email: string, actionCodeSettings?: ActionCodeSettings | undefined): Promise<boolean> {
    throw new Error('Function not implemented.');
  },
  sendPasswordResetEmailLoading: false,

  verifyBeforeUpdateEmail: function (email: string, actionCodeSettings: ActionCodeSettings | null): Promise<boolean> {
    throw new Error('Function not implemented.');
  },
