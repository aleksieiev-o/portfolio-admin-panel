...
const Projects: FC<StaticProps<Array<IProject>>> = ({
  payload,
}): ReactElement => {
  ...
  const [preparedToRemoveProject, setPreparedToRemoveProject] =
    useState<IProject>({} as IProject);
      ...
      <BaseContentHeaderContainer>
        {payload.length && (
          ...
          >
            <Button
              colorScheme={'teal'}
              onClick={() => handlePrepareCreateProject()}
              boxShadow={'md'}
            >
              Create project
            </Button>
                    ...
                    <GridItem overflow={'hidden'}>
                      <Stack direction={'column'} w={'full'} spacing={4}>
                        ...
                        >
                          ...
                          <Button
                            onClick={() =>
                              window.open(projectCard.repository, '_blank')
                            }
                            variant={'link'}
                            colorScheme={'teal'}
                        ...
                        >
                          ...
                          <Button
                            onClick={() =>
                              window.open(projectCard.demo, '_blank')
                            }
                            variant={'link'}
                            colorScheme={'teal'}
                        ...
                        >
                          ...
                          <Text>
                            {new Date(projectCard.releaseDate).toDateString()}
                          </Text>
                        </Stack>
                        ...
                        >
                          ...
                          <Tooltip
                            label={
                              projectCard.visibility ? 'Visible' : 'Hidden'
                            }
                            aria-label={'project visibility'}
                          >
                            <Icon
                              color={
                                projectCard.visibility ? 'teal.500' : 'red.500'
                              }
                              as={
                                projectCard.visibility
                                  ? VisibilityIcon
                                  : VisibilityOffIcon
                              }
                            />
                ...
                <CardFooter p={4}>
                  ...
                  >
                    <Button
                      onClick={() =>
                        router.push(
                          ProtectedRoutePath.UPDATE_PROJECT.replace(
                            '[id]',
                            projectCard.id,
                          ),
                        )
                    ...
                    <Button
                      onClick={() => handlePrepareRemoveById(projectCard)}
                      variant={'solid'}
                      colorScheme={'red'}
                      boxShadow={'md'}
                    >
