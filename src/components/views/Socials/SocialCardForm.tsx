...
const SocialCardForm: FC<Props> = (props): ReactElement => {
  ...
  const handleFormSubmit = async (
    ...
    formikHelpers: FormikHelpers<TypeCreateSocialDto>,
  ) => {
    setIsLoading(true);
    ...
    try {
      if (type === 'create') {
        ...
        await updateById<TypeCreateSocialDto>(
          payload,
          EndpointsList.SOCIALS,
        ...
        <Grid templateColumns={{md: 'repeat(2, 1fr)'}} gap={6} w={'full'}>
          <GridItem>
            ...
            >
              ...
              <FormControl
                isRequired={true}
                isInvalid={Boolean(touched.iconName && errors.iconName)}
              >
                ...
                {touched.iconName && Boolean(errors.iconName) && (
          ...
          <GridItem>
            ...
            >
              ...
              <FormControl>
                <FormLabel htmlFor={'social-visibility'}>
