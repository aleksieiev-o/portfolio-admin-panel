...
const SkillsCreate: FC = (): ReactElement => {
  return (
    <div className="h-hull flex w-full flex-col gap-6">
      <div className="flex w-full flex-row items-start justify-start gap-6 pt-6">
        ...
        <PageTitle title={RouteName.SKILLS_CREATE} />
      </div>

      <CreateOrUpdateSkillForm mode="create" data={undefined} isPending={false} isSuccess={false} />
    </div>
  );
};
