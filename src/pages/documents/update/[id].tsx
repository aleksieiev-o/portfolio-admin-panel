...
const UpdateDocumentPage: NextPageWithAuth<StaticProps<IDocument>> = ({payload}): ReactElement => {
  return (
...
export const getStaticProps: GetStaticProps<StaticProps<IDocument>> = async (context): Promise<StaticPropsResponse<IDocument>> => {
  try {
