...
const DocumentsPage: NextPageWithAuth<StaticProps<Array<IDocument>>> = ({payload}): ReactElement => {
  return (
...
export async function getStaticProps(): Promise<StaticPropsResponse<Array<IDocument>>> {
