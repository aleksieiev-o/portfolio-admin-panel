...
const UpdateProjectPage: NextPageWithAuth<StaticProps<IProject>> = ({
  payload,
}): ReactElement => {
  return (
...
export const getStaticProps: GetStaticProps<StaticProps<IProject>> = async (
  context,
): Promise<StaticPropsResponse<IProject>> => {
  try {
