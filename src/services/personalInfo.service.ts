...
export const updatePersonalInfo = async (payload: IUpdatePayload): Promise<void> => {
  return await update(child(ref(firebaseDataBase), Endpoints.PERSONAL_INFO), {[payload.field]: payload.value});
};
